...
public class FrontControllerServlet extends HttpServlet {
	...
	public void navegar(HttpServletRequest request, HttpServletResponse response, String paginaDestino)
		...
		/*
		 * Solicitud de la acción a través del command pattern, la clase RequestUtil funciona como factory para las
		 * acciones
		 */
		RequestUtil requestUtil = new RequestUtil(request);
		Action action = requestUtil.getAction();
		String targetPage = action.performAction(request, response);
